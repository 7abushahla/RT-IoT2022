...
def main():
    ap = argparse.ArgumentParser(description="Build & run C/C++ models (Treelite or header-only) in one go")
    ...
    has_header_only = has_rf_header or has_svm_header
    ...
    if has_header_only:
        ...
        needs_cxx = has_svm_header or is_cxx(bench_src.suffix)
