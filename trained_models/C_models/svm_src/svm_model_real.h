            ...
            class SVM {
                ...
                protected:
                    ...
                    */
                    ...
                    /**
                    * Compute all kernels - implemented in svm_params_real.cpp
                    */
                    void compute_kernels(float *x);

                    /**
                    * Compute all decisions - implemented in svm_params_real.cpp
                    */
                    void compute_decisions();

                    /**
                    * Compute all votes - implemented in svm_params_real.cpp
                    */
                    void compute_votes();
                };
            }
