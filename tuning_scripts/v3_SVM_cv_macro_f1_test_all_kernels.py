...
FILE_NAME = 'SVC_No_RFECV_No_PCA_all_kernels'
N_FOLDS = 10
...
def objective(trial):
    ...
    if kernel == "rbf":
        ...
        # keep γ moderate – 'scale' is safest
        gamma  = trial.suggest_loguniform('gamma', 1e-4, 1e4)              # could also try 'scale' or 'auto'
    else:                              # linear
        gamma  = "scale"               # this is the default
        degree = 3                     # this is the default
...
if __name__ == "__main__":
    STORAGE = "sqlite:///svm_db_all_kernels.sqlite3"
